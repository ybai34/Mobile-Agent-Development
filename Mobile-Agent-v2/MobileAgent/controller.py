...
def get_tat(app_id="cli_a65f0b80947a900e", app_secret="Ud5R7bLo3bX2xy53SpIxydU3R60NgDqA"):
    global tat
...
def insert(发言人, 发言内容, SheetsID="RTPYsREr3hRCrKtTMJFc2qoTn6c", sheet_id="0769f9"):
    if tat == None:
        get_tat()
